...
REPO_URL="https://github.com/rhapsody008/devops-lab-gitops.git"
SECRET_NAME="git"
BRANCH="main"
OUTPUT_PROJECT_FILE="./base/project.yaml"
OUTPUT_GITOPS_FILE="./base/gitops-sources.yaml"
...
SERVICE_PORT=3000
OUTPUT_INGRESS_FILE="./base/ingress.yaml"
